...
public class SaxModelParserTest {
	...
	private <T> T test(File file, ContentExpertRegistry registry) {
		try {
			...
			SaxContext saxContext = SaxParser.parse().setValidating(false).setHandler(handler);
	...
	public void testSimple() {
		SaxParserTestRegistry registry = new SaxParserTestRegistry();
