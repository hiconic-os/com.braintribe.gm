...
/**
 * A {@link Predicate} meta-data that marks models which are packaged with tribefire. 
 */
public interface CoreModel extends ExplicitPredicate, ModelMetaData {

	EntityType<CoreModel> T = EntityTypes.T(CoreModel.class);
