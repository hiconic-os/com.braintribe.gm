...
/**
 * Erasure is {@link Outline}
 */
public interface Inline extends EntityTypeMetaData, PropertyMetaData, ExplicitPredicate {

	EntityType<Inline> T = EntityTypes.T(Inline.class);
