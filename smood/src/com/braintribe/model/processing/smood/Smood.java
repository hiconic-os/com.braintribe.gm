 ...
 */
public class Smood implements SmoodInterface, IncrementalAccess, ReflectiveIndexingRepository {
	...
	@Override
	@Deprecated
	public void unregisterEntity(GenericEntity entity, EntityType<GenericEntity> entityType) {
	...
	private void w_unregisterEntity(GenericEntity entity) {
		...
		populationManager.w_removeEntity(entity);
	}
	...
	private void w_setMetaModel(GmMetaModel metaModel) {
		...
		this.populationManager.w_setCmdResolver(cmdResolver);
	...
	private class ManipulationListenerImpl implements ManipulationListener {
		...
		private void w_noticeManipulation(ChangeValueManipulation changeValueManipulation) {
			...
			populationManager.w_onChangeValue(entity, propertyName, oldValue, changeValueManipulation.getNewValue());
		}
	...
	private void w_registerEntityInternally(GenericEntity entity) {
		...
		populationManager.w_registerEntity(entity);
