...
public class TraverseTest {
	...
	public void testTraversing() {
		...
		entity.setTestEnum(TestEnum.one);
		
		GMF.getTypeReflection().getBaseType().traverse(entity, null, new TraversingVisitor() {
			@Override
			public void visitTraversing(TraversingContext traversingContext) {
				System.out.println(traversingContext.getObjectStack().peek());
			}
		});
