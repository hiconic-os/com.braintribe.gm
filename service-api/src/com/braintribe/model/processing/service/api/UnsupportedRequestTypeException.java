...
/**
 * This exception is thrown when a request is to be handled that is not covered by an implementation
 * @author dirk.scheffler
 *
 */
@SuppressWarnings("serial")
public class UnsupportedRequestTypeException extends ServiceProcessorAddressingException {
