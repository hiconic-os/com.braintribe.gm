...
public class JseReturn extends JseNode {
	private static final char[] returnOpening = "return ".toCharArray();
	private JseNode value;
	
	public JseReturn(JseNode value) {
		super();
		this.value = value;
	}
