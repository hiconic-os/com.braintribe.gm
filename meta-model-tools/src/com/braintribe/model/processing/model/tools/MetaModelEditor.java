...
import static com.braintribe.model.processing.model.tools.GmMappers.typeOverrideToSignature;
import static com.braintribe.model.processing.model.tools.GmMappers.typeToSignature;
...
/**
 * @deprecated Use {@link ModelMetaDataEditor} instead (implementation is BasicModelMetaDataEditor in artifact
 *             model-oracle)
 */
@Deprecated
public class MetaModelEditor {
	...
	public GmProperty getCurrentProperty() {
	 ...
	 * {@link #acquirePropertyOverride(EntityType, EntityType, String)} method and provide the declaring type
	 * explicitly.
	 */
	...
	public <T extends GenericEntity> GmPropertyOverride acquirePropertyOverride(EntityType<T> entityType, EntityType<? super T> declaringType,
			String propertyName) {
		acquireEntityOverride(entityType);
	...
	public GmEntityType getCurrentEntity() {
	...
	public void setCurrentEntity(GmEntityType currentEntity) {
	...
	public GmEnumType getCurrentEnum() {
		return currentEnum;
	}
	...
	public void setCurrentEnum(GmEnumType currentEnum) {
	...
	public GmEnumConstant getCurrentConstant() {
