 ...
 * 
 */
public class EncodedSecretKeyLoader extends EncodedKeyLoader implements SecretKeyLoader<EncodedSecretKey, SecretKey> {

	@Override
	public SecretKey load(EncodedSecretKey encodedSecretKey) throws EncryptionTokenLoaderException {

		SecretKey secretKey = loadKey(SecretKey.class, encodedSecretKey);
