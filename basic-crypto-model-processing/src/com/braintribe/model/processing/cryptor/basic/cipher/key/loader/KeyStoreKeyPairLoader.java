 ...
 * 
 */
public class KeyStoreKeyPairLoader extends KeyStoreEntryLoader implements KeyPairLoader<KeyStoreKeyPair> {

	@Override
	public KeyPair load(KeyStoreKeyPair keyStoreKeyPair) throws EncryptionTokenLoaderException {

		KeyPair keyPair = loadKey(KeyPair.class, keyStoreKeyPair);
