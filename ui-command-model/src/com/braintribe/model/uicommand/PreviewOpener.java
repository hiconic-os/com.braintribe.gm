...
public interface PreviewOpener extends Command {
	
	final EntityType<PreviewOpener> T = EntityTypes.T(PreviewOpener.class);
	
	GenericEntity getContent();
	void setContent(GenericEntity content);
