...
@UnsatisfiedBy(MissingSession.class)
public interface GetWebAuthorization extends WebAuthorizationRequest {
	EntityType<GetWebAuthorization> T = EntityTypes.T(GetWebAuthorization.class);
}
