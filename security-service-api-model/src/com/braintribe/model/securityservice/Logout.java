...
@Description("Closes current user session.")
public interface Logout extends SecurityRequest, AuthorizableRequest {

	EntityType<Logout> T = EntityTypes.T(Logout.class);
