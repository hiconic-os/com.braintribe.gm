...
public interface ProtoGmEnumConstantOverride extends ProtoGmEnumConstantInfo {

	ProtoGmEnumConstant getEnumConstant();

	ProtoGmEnumTypeOverride getDeclaringTypeOverride();

	@Override
	default ProtoGmEnumConstant relatedConstant() {
		return getEnumConstant();
	}

	@Override
	default ProtoGmEnumTypeInfo declaringTypeInfo() {
