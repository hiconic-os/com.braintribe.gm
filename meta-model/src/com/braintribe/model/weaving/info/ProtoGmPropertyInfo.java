...
public interface ProtoGmPropertyInfo extends ProtoGmCustomModelElement, ProtoHasMetaData {

	Object getInitializer();
	void setInitializer(Object initializer);

	ProtoGmProperty relatedProperty();

	ProtoGmEntityTypeInfo declaringTypeInfo();
