 ...
 * 
 * @see ProtoGmCustomTypeInfo
 * @see ProtoGmPropertyInfo
 * @see ProtoGmEnumConstantInfo
 */

public interface ProtoGmCustomModelElement extends ProtoGmModelElement {

	ProtoGmMetaModel declaringModel();
