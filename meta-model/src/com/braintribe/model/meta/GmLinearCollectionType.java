...
@Abstract
public interface GmLinearCollectionType extends ProtoGmLinearCollectionType, GmCollectionType {

	EntityType<GmLinearCollectionType> T = EntityTypes.T(GmLinearCollectionType.class);
