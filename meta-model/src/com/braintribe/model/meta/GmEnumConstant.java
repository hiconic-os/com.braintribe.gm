...
public interface GmEnumConstant extends ProtoGmEnumConstant, GmEnumConstantInfo {

	EntityType<GmEnumConstant> T = EntityTypes.T(GmEnumConstant.class);
	...
	@Override
	GmEnumType getDeclaringType();
	void setDeclaringType(GmEnumType declaringType);
