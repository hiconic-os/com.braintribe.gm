...
public interface GmDecimalType extends ProtoGmDecimalType, GmSimpleType {

	EntityType<GmDecimalType> T = EntityTypes.T(GmDecimalType.class);

	@Initializer("'decimal'")
	@Override
	String getTypeSignature();

	@Initializer("'type:decimal'")
	@Override
	String getGlobalId();

	@Override
	default GmTypeKind typeKind() {
		return GmTypeKind.DECIMAL;
	}
