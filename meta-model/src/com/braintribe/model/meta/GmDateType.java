...
public interface GmDateType extends ProtoGmDateType, GmSimpleType {

	EntityType<GmDateType> T = EntityTypes.T(GmDateType.class);

	@Initializer("'date'")
	@Override
	String getTypeSignature();

	@Initializer("'type:date'")
	@Override
	String getGlobalId();

	@Override
	default GmTypeKind typeKind() {
		return GmTypeKind.DATE;
	}
