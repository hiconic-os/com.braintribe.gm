...
@SelectiveInformation("${typeSignature}")
@Abstract
@Singleton
public interface GmSimpleType extends ProtoGmSimpleType, GmScalarType {

	EntityType<GmSimpleType> T = EntityTypes.T(GmSimpleType.class);
