...
// ============================================================================
package com.braintribe.gm.config.wire.space;
...
@Managed
public class ModeledConfigurationSpace implements ModeledConfigurationContract {

	@Override
	@Managed
	public ModeledConfiguration config() {
		return new DefaultModeledConfiguration();
	}
