...
public interface StandardIdentifiable extends GenericEntity {

	EntityType<StandardIdentifiable> T = EntityTypes.T(StandardIdentifiable.class);

	@TypeSpecification(Long.class)
	@Override
	<T> T getId();
