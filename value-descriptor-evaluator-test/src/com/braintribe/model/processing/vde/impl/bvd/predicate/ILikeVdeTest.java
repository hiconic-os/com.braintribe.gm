...
public class ILikeVdeTest extends AbstractPredicateVdeTest {
	
	@Test
	public void testStringILike() throws Exception {

		Ilike predicate = $.ilike();
		predicate.setLeftOperand("Hello");
		predicate.setRightOperand("h*");
