...
/**
 * An {@link IdentityManager} that synchronizes entities based on their id property. 
 */
public class IdPropertyIdentityManager extends ConfigurableIdentityManager {
	
	
	private final EntityType<GenericEntity> type = typeReflection.getEntityType(GenericEntity.class);
	
	public IdPropertyIdentityManager() {
		super();
	...
	public Collection<String> getIdentityProperties(GenericEntity instance, EntityType<? extends GenericEntity> entityType, SynchronizationContext context) {
		// PGA TODO ID
		return Collections.singleton(GenericEntity.id);
	}
