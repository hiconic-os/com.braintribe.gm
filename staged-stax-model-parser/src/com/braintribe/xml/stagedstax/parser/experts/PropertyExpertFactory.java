...
public class PropertyExpertFactory extends AbstractContentExpertFactory implements ContentExpertFactory {

	private String signature;
	
	public PropertyExpertFactory( String signature) {
		this.signature = signature;
	}
	@Override
	public ContentExpert newInstance() {
		return new PropertyExpert( signature);
	}
