...
public interface ValueConditionCriterion extends StackElementCriterion {

	final EntityType<ValueConditionCriterion> T = EntityTypes.T(ValueConditionCriterion.class);
	...
	default CriterionType criterionType() {
		return CriterionType.VALUE_CONDITION;
	}
}
