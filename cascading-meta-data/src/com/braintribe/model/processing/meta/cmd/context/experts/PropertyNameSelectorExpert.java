...
/**
 * @see PropertyNameSelector
 */
public class PropertyNameSelectorExpert implements SelectorExpert<PropertyNameSelector> {

	@Override
	public Collection<Class<? extends SelectorContextAspect<?>>> getRelevantAspects(PropertyNameSelector selector) throws Exception {
		return MetaDataTools.aspects(GmPropertyAspect.class);
	}

	@Override
	public boolean matches(PropertyNameSelector selector, SelectorContext context) throws Exception {
		...
		return gmProperty.getName().equals(selector.getPropertyName());
	}
