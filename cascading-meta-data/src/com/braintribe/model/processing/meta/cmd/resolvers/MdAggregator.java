 ...
 * 
 * @Name - this was originally a MetaDataResolver, but the name was confusing with {@link MdResolver}, so I decided to
 *       call this hierarchy "aggregators" to clearly separate the two.
 */
public abstract class MdAggregator {
	...
	/**
	 * Getting rid of all empty lists, so we do not hold unnecessary references. Also, the first list will be a merge of
	 * first list from normal MD and all the important MDs, thus creating the illusion as if all the "important" MDs were
	 * actually local ones.
	 */
	...
	/**
	 * @param ownerIndex
	 *            this is used when resolving entity related meta data (entity/property), and in those cases this method is
	 *            overridden.
	 */
	...
	/**
	 * Provides local context - the one that remains constant for given MetaData holder. For example resolver for given
	 * entity should provide corresponding GmEntityType through this method. In general, all the aspects
	 */
