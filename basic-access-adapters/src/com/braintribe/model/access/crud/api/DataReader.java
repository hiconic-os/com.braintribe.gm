...
/**
 * A marker interface for all reading expert implementations used by the
 * {@link CrudExpertAccess}.
 * 
 * @see EntityReader
 * @see PopulationReader
 * @see PropertyReader
 * 
 * @author gunther.schenk
 */
public interface DataReader<T extends GenericEntity> extends CrudExpert<T> {
	// empty
}
