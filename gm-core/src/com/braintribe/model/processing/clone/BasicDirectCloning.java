...
public class BasicDirectCloning extends AbstractDirectCloning {
	...
	protected CloneTarget acquireCloneTarget(GenericEntity entity) {
		return entities.computeIfAbsent(entity, e -> new BasicCloneTarget(e.entityType().createRaw(), true));
	}
