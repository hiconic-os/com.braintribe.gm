...
public class TcEvaluation {
	private static final GenericTypeConditionExpert DEFAULT_INSTANCE = GenericTypeConditionExpert.getDefaultInstance();
	...
	private boolean matchesTypeCondition(TraversingNodeHolder nodeHolder, TypeConditionCriterion typeConditionCriterion) {
		...
		if (node != null) {
			...
			return DEFAULT_INSTANCE.matchesTypeCondition(typeCondition, type);
		}
		else
			return false;
