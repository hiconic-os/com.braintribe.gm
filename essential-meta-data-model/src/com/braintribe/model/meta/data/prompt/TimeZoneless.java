...
public interface TimeZoneless extends UniversalMetaData, ExplicitPredicate, ModelSkeletonCompatible {

	EntityType<TimeZoneless> T = EntityTypes.T(TimeZoneless.class);
