...
@Abstract
public interface LifecycleManipulation extends AtomicManipulation {

	EntityType<LifecycleManipulation> T = EntityTypes.T(LifecycleManipulation.class);

	/** Entity itself or EntityReference */
	...
	default boolean isRemote() {
		...
		return entity instanceof EntityReference && entity.getId() == null;
	}
