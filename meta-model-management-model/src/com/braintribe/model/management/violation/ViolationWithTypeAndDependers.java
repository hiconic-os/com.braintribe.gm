...
public interface ViolationWithTypeAndDependers extends MetaModelValidationViolation {

	EntityType<ViolationWithTypeAndDependers> T = EntityTypes.T(ViolationWithTypeAndDependers.class);

	public TypeLink getTypeLink();
	public void setTypeLink(TypeLink typeLink);
	
	public Set<Link> getDependerLinks();
	public void setDependerLinks(Set<Link> dependerLinks);
