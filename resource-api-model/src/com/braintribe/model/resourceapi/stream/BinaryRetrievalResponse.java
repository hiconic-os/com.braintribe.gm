...
@Abstract
public interface BinaryRetrievalResponse extends BinaryResponse, HasCacheControl, RangeResponse {

	EntityType<BinaryRetrievalResponse> T = EntityTypes.T(BinaryRetrievalResponse.class);
