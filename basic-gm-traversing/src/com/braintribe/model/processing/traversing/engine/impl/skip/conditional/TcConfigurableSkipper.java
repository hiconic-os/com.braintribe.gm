...
/**
 * A {link ConditionalSkipper} that evaluates the skip based on {@link TraversingCriterion}
 */
public class TcConfigurableSkipper extends ElementTypeOrientedVisitor implements ConditionalSkipper {
	...
	private GmTraversingSkippingCriteria skippingCriteria = GmTraversingSkippingCriteria.skipDescendants;
	...
	/** Alternative to setting {@link #setTraversionCriterion(TraversingCriterion) traversing criterion.} */
	public void setMatcher(StandardMatcher matcher) {
	...
	protected void associateTc(GmTraversingContext context, IModelPathElement pathElement, BasicCriterion tc, BasicCriterion optionalPredecessor,
			Object optionalPredecessorValue) {
		IModelPathElement pathElementPredecessor = pathElement.getPrevious();
		TcLinkedListNode predecessor = pathElementPredecessor != null
				? (TcLinkedListNode) context.getVisitorSpecificCustomValue(pathElementPredecessor) : null;
