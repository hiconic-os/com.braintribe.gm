 ...
 * @author peter.gazdik
 */
public class UnmarshallingLenienatingInterceptor implements ServiceAroundProcessor<ServiceRequest, Object> {

	@Override
	public Object process(ServiceRequestContext requestContext, ServiceRequest request, ProceedContext proceedContext) {
		ServiceRequestContext lenientContext = requestContext.derive().set(DecodingLenienceOption.class, new DecodingLenience(true)).build();

		return proceedContext.proceed(lenientContext, request);
	}
