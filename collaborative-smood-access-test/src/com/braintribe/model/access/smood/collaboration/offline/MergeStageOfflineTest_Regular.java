...
import com.braintribe.model.access.smood.collaboration.manager.MergeStageCsaTest_Regular;
 ...
 * 
 */
public class MergeStageOfflineTest_Regular extends MergeStageCsaTest_Regular {
	...
	protected void assertSetMergedCorectly() {
		assertOldDataFileContains(".stringSet+{'zero':'zero','one':'one'}");
	}
