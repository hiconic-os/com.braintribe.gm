...
/**
 * Based on {@link CortexCsaTest}, but for the case where we don't use a splitter anymore, thus we store data in data.man only.
 * 
 * @see CollaborativeAccess
 * 
 * @author peter.gazdik
 */
public class Cortex_NonSplitting_CsaTest extends AbstractCollaborativePersistenceTest {
	...
	@Test
	public void creatingModelStoresDataFile() {
	...
	@Test
	public void creatingModelWithDataStoresInDataFiles() {
