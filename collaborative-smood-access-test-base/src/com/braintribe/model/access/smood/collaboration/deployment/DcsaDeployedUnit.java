 ...
 * @author peter.gazdik
 */
public class DcsaDeployedUnit extends AbstractCsaDeployedUnit<DistributedCollaborativeSmoodAccess4Test> {

	public Lock distributedLock;
	public DcsaSharedStorage sharedStorage;
	public Hub<String> markerPersistence;
