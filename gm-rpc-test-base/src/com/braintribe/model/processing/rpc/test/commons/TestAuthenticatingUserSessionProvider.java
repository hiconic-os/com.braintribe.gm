...
/**
 * A {@link AuthenticatingUserSessionProvider} which facilitates the invalidation of current UserSession.
 */
public class TestAuthenticatingUserSessionProvider extends AuthenticatingUserSessionProvider<Credentials> {

	public synchronized UserSession invalidateCurrentUserSession() {

		UserSession currentUserSession = get();

		if (currentUserSession != null) {
			LogoutSession logout = LogoutSession.T.create();
			logout.setSessionId(currentUserSession.getSessionId());
