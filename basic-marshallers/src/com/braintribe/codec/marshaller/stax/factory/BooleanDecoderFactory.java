...
public class BooleanDecoderFactory extends DecoderFactory {
	public static final BooleanDecoderFactory INSTANCE = new BooleanDecoderFactory(); 
	@Override
	public Decoder newDecoder(DecoderFactoryContext context, String elementName, Attributes attributes) throws MarshallException {
		return new BooleanDecoder(true);
	}
}
