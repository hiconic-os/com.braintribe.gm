...
public class DoubleDecoderFactory extends DecoderFactory {
	public static final DoubleDecoderFactory INSTANCE = new DoubleDecoderFactory();
	@Override
