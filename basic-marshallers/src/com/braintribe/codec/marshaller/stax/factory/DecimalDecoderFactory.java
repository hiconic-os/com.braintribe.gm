...
public class DecimalDecoderFactory extends DecoderFactory {
	public static final DecimalDecoderFactory INSTANCE = new DecimalDecoderFactory();
	@Override
	public Decoder newDecoder(DecoderFactoryContext context, String elementName, Attributes attributes) throws MarshallException {
		return new DecimalDecoder(true);
	}
}
