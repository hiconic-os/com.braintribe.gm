...
public class EntityReferenceDecoderFactory extends DecoderFactory {
	public static final EntityReferenceDecoderFactory INSTANCE = new EntityReferenceDecoderFactory();
	@Override
	public Decoder newDecoder(DecoderFactoryContext context, String elementName, Attributes attributes) throws MarshallException {
		return new EntityReferenceDecoder(true);
	}
}
