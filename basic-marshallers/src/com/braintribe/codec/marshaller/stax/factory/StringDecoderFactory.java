...
public class StringDecoderFactory extends DecoderFactory {
	public static final StringDecoderFactory INSTANCE = new StringDecoderFactory();
	@Override
