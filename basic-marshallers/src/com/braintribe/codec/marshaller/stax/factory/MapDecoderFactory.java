...
public class MapDecoderFactory extends DecoderFactory {

	private DecoderFactory keyDecoderFactory;
	private DecoderFactory valueDecoderFactory;
	
	public MapDecoderFactory(DecoderFactory keyDecoderFactory, DecoderFactory valueDecoderFactory) {
	...
	public Decoder newDecoder(DecoderFactoryContext context, String elementName, Attributes attributes) throws MarshallException {
		return new MapDecoder(keyDecoderFactory, valueDecoderFactory);
	}
}
