...
public class DecimalNode extends ValueStaxNode {
	private static final char[] endElement = "</D>".toCharArray();
	private static final char[] startPropElementClose = "'>".toCharArray();
	private static final char[] startPropElement = "<D p='".toCharArray();
	private static final char[] startElement = "<D>".toCharArray();
