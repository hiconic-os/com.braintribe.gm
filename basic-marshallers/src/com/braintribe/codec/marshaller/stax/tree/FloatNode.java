...
public class FloatNode extends ValueStaxNode {
	private static final char[] endElement = "</f>".toCharArray();
	private static final char[] startPropElementClose = "'>".toCharArray();
	private static final char[] startPropElement = "<f p='".toCharArray();
	private static final char[] startElement = "<f>".toCharArray();
