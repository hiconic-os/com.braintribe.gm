...
public class IntegerNode extends ValueStaxNode {
	private static final char[] endElement = "</i>".toCharArray();
	private static final char[] startPropElementClose = "'>".toCharArray();
	private static final char[] startPropElement = "<i p='".toCharArray();
	private static final char[] startElement = "<i>".toCharArray();
