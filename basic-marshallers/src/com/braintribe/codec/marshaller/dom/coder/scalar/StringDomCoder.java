...
public class StringDomCoder extends DomTextCoder<String> {
	
	public StringDomCoder() {
		super("s");
	}
	
	@Override
	protected String encodeText(DomEncodingContext context, String value) {
		return value;
	}
	
	@Override
	protected String decodeText(DomDecodingContext context, String text) {
		return text;
	}
}
