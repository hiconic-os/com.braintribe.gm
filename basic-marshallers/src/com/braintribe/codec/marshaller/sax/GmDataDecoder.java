...
class GmDataDecoder extends ValueDecoder {
	...
	public void onDescendantEnd(DecodingContext context, Decoder decoder)
			throws MarshallException {
		if (decoder instanceof RootValueDecoder) {
			RootValueDecoder rootValueDecoder = (RootValueDecoder)decoder;
			value = rootValueDecoder.getValue(context);
		}
	}
}
