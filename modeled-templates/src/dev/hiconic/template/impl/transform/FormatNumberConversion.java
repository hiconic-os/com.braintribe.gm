...
public class FormatNumberConversion implements ValueConversion<Number, FormatNumber, String> {
	@Override
	public Maybe<String> convert(TemplateEvaluationContext context, Number input, FormatNumber params) {
		if (input == null)
