...
import dev.hiconic.template.impl.node.BreakEvaluator;
...
import dev.hiconic.template.impl.node.ContinueEvaluator;
...
import dev.hiconic.template.impl.node.RenderTemplateEvaluator;
...
import dev.hiconic.template.impl.node.WhileEvaluator;
import dev.hiconic.template.impl.node.RepeatEvaluator;
...
import dev.hiconic.template.impl.vd.ContainsEvaluator;
import dev.hiconic.template.impl.vd.ContainsKeyEvaluator;
import dev.hiconic.template.impl.vd.ContainsValueEvaluator;
...
import dev.hiconic.template.impl.vd.SizeEvaluator;
...
public final class StandardTemplateExperts {
	...
	private static void registerNodes(TemplateExpertRegistry registry) {
		...
		registry.registerEvaluator(While.T, new WhileEvaluator());
		registry.registerEvaluator(Repeat.T, new RepeatEvaluator());
		registry.registerEvaluator(RenderTemplate.T, new RenderTemplateEvaluator());
		...
		registry.registerEvaluator(dev.hiconic.template.model.core.instr.RemoveAt.T, new CollectionMutationEvaluator<>());
		registry.registerEvaluator(Break.T, new BreakEvaluator());
		registry.registerEvaluator(Continue.T, new ContinueEvaluator());
	...
	private static void registerValueDescriptors(TemplateExpertRegistry registry) {
		...
		registry.registerVdEvaluator(Size.T, new SizeEvaluator());
		registry.registerVdEvaluator(Contains.T, new ContainsEvaluator());
		registry.registerVdEvaluator(ContainsKey.T, new ContainsKeyEvaluator());
		registry.registerVdEvaluator(ContainsValue.T, new ContainsValueEvaluator());
