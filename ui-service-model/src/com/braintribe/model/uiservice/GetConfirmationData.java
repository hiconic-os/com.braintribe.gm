...
public interface GetConfirmationData extends DomainRequest, DispatchableRequest, AuthorizedRequest {
	
	EntityType<GetConfirmationData> T = EntityTypes.T(GetConfirmationData.class);
