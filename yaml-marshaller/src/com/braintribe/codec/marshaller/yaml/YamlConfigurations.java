...
import com.braintribe.codec.marshaller.yaml.api.ConfigurationReadBuilder;
 ...
 * @deprecated use YamlConfigurations from the artifact com.braintribe.gm:modeled-yaml-config instead
 */
@Deprecated
		...
		public Maybe<E> from(File file) {
			...
			return from(() -> new FileInputStream(file));
				...
				return Reasons.build(NotFound.T) //
						.text("Could not read " + type.getTypeSignature() + " because configuration file does not exist: " + file.getAbsolutePath()) //
						.toMaybe();
		}
