...
public class PaginationTest extends AbstractQueryParserTest {
	...
	public void testLimitOffset() throws Exception {
		...
		String queryString = "select * from " + Person.class.getName() + " p limit 10 offset 200";
	...
	public void testLimit() throws Exception {
		...
		String queryString = "select * from " + Person.class.getName() + " p limit 10 ";
	...
	public void testOffset() throws Exception {
		...
		String queryString = "select * from " + Person.class.getName() + " p offset 200 ";
