...
public class DateIdGenerator implements IdGenerator<Date>, com.braintribe.model.generic.processing.IdGenerator {
	...
	@Override
	public Date generateId(IdGeneratorContext context) throws IdCreationException {
		return new Date();
	}
