...
public class AssemblyMonitoring {
	...
	@Deprecated
	public AssemblyMonitoring(NotifyingGmSession session, GenericEntity root) {
		init(session, new EntityOrigin(root));
	}
	
	/** @deprecated use {@link #newInstance()} instead */
	@Deprecated
	public AssemblyMonitoring(NotifyingGmSession session, GenericEntity root, Property property) {
		init(session, new PropertyOrigin(property, root));
	}
	
	/** @deprecated use {@link #newInstance()} instead */
	@Deprecated
	public AssemblyMonitoring(NotifyingGmSession session, EnhancedList<?> list) {
		init(session, new CollectionOrigin(list));
	}
	
	/** @deprecated use {@link #newInstance()} instead */
	@Deprecated
	public AssemblyMonitoring(NotifyingGmSession session, EnhancedSet<?> set) {
		init(session, new CollectionOrigin(set));
	}
	
	/** @deprecated use {@link #newInstance()} instead */
	@Deprecated
	public AssemblyMonitoring(NotifyingGmSession session, EnhancedMap<?,?> map) {
		init(session, new CollectionOrigin(map));
	}
