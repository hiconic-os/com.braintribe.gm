...
public class BasicQueryStringifier implements QueryStringifier {
	...
	public BasicQueryStringifier hideConfidential() {
		this.hideConfidential = true;
		return this;
	}
	...
	public String stringify(Object queryValue) throws QueryStringifierRuntimeException {
		try {
			...
			context.setShortening(shortening);
			context.setExpertRegistry(expertRegistry);
			context.setHideConfidential(hideConfidential);
