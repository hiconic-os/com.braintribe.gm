...
public class BasicTemplateBuilder implements TemplatePrototypeBuilder, TemplateBuilder<Object>, TemplateRecordingContext<Object>, TemplatePrototypingContext, ManipulationListener {
	...
	private Template template = Template.T.create();
	private Deque<AbstractVdPushContext> vdStack = new ArrayDeque<>();
	...
	private class VariablePushContext extends AbstractVdPushContext {
		...
		private DynamicPropertyMetaDataAssignment dynamicPropertyMetaDataAssignment;
		...
		public DynamicPropertyMetaDataAssignment getDynamicPropertyMetaDataAssignment() {
			if (dynamicPropertyMetaDataAssignment == null) {
				dynamicPropertyMetaDataAssignment = DynamicPropertyMetaDataAssignment.T.create();
				dynamicPropertyMetaDataAssignment.setVariable(variable);
				BasicTemplateBuilder.this.addMetaData(dynamicPropertyMetaDataAssignment);
			}

			return dynamicPropertyMetaDataAssignment;
		}
