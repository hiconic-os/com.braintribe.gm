...
public class GraphFetchingTest implements GraphFetchingTestConstants {
	...
	private static SmoodAccess access = GmTestTools.newSmoodAccessMemoryOnly(ACCESS_ID_TEST,
			GMF.getTypeReflection().getModel(_GraphFetchingTestModel_.name).getMetaModel());
	...
	public void testReachable() {
		...
		EntityGraphNode graphNode = Fetching.reachable(Company.T);
