...
public class GraphFetchingTest implements GraphFetchingTestConstants {
	private static final com.braintribe.logging.Logger logger = com.braintribe.logging.Logger.getLogger(GraphFetchingTest.class);

	private static GmMetaModel model = GMF.getTypeReflection().getModel(_GraphFetchingTestModel_.name).getMetaModel();
