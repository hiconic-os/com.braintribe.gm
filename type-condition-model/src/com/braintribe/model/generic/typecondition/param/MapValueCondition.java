...
public interface MapValueCondition extends TypeParameterCondition {

	EntityType<MapValueCondition> T = EntityTypes.T(MapValueCondition.class);
	...
	default boolean matches(GenericModelType type) {
		...
		GenericModelType parameterType = ((MapType) type).getValueType();
	...
	default boolean matches(GmType type) {
		...
		GmType parameterType = ((GmMapType) type).getValueType();
	...
	default TypeConditionType tcType() {
		return TypeConditionType.mapValueCondition;
	}
