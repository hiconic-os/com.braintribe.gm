...
// ============================================================================
package com.braintribe.gm.config.yaml.wire.space;
...
@Managed
public class ModeledYamlConfigurationSpace implements ModeledConfigurationContract {

	@Import
	private YamlConfigurationsLocationContract yamlConfigurationsLocation;
	
	@Override
	@Managed
	public ModeledConfiguration config() {
		ModeledYamlConfiguration bean = new ModeledYamlConfiguration();
		bean.setConfigFolder(yamlConfigurationsLocation.configDir());
		return bean;
	}
}
