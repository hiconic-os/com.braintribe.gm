 ...
 * @author peter.gazdik
 */
public interface CsaStoreResource extends CsaResourceBasedOperation, CsaBinaryOperation {

	EntityType<CsaStoreResource> T = EntityTypes.T(CsaStoreResource.class);

	String resourceRelativePath = "resourceRelativePath";

	@Override
	default CsaOperationType operationType() {
		return CsaOperationType.STORE_RESOURCE;
	}
