...
public class AnnotatedServiceProcessorTest {
	...
	public void testRegular() throws Exception {
		var annotatedProcessor = new AnnotatedTestProcessor();
		var processor = ServiceProcessors.dispatcher(annotatedProcessor);
	...
	public void testReasoned() throws Exception {
		var annotatedProcessor = new AnnotatedTestReasonedProcessor();
		var processor = (ReasonedServiceProcessor<AnnoTestRequest, String>) ServiceProcessors.dispatcher(annotatedProcessor);
